      ...
      <div className="p-4 border-b border-border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-muted/30">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <h2 className="text-lg font-bold tracking-tight text-foreground leading-none mb-1.5 truncate">
              Edit Geofence
            </h2>
            <p className="text-[11px] text-muted-foreground flex flex-wrap items-center gap-1.5 leading-none">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <Button 
            ...
            className="flex-1 sm:flex-none h-8 px-4 text-xs font-bold border-border bg-background shadow-sm hover:bg-muted transition-all"
          >
            Discard
          </Button>
          <Button 
