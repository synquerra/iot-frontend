...
export default function StopSOS() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setNotification({
        type: 'success',
        message: 'SOS mode stopped successfully'
      });
      ...
      let errorMessage = 'Failed to stop SOS mode';
    ...
    <div className="bg-gray-50 min-h-screen p-3 sm:p-4 md:p-6">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              ...
              <p className="text-sm sm:text-base text-gray-600 mb-3">
                Deactivate emergency SOS mode on the device
              </p>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="bg-gradient-to-r from-red-600 to-red-700 px-4 sm:px-6 py-4 rounded-t-lg">
          ...
          <p className="text-red-100 text-xs sm:text-sm mt-1">Deactivate emergency mode</p>
        </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  This command will stop the SOS emergency mode on the selected device. 
                  The device will return to normal operation mode. Use this when the emergency situation has been resolved.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-gray-50 px-3 sm:px-4 md:px-6 pb-6">
        <CommandHistory imei={imei} commandType="STOP_SOS" triggerRefresh={refreshTrigger} />
      </div>
    </div>
  );
}
